...
import com.phoenixunknownapps.figurarushextreme.IGame;
...
public class GameActivity extends Activity {
    ...
    private IGame.GameCallback gameCallback = new IGame.GameCallback() {
        ...
        public void onGameEnd(final long timeMs, final int score) {
            ...
            Bundle b = new Bundle();
            b.putInt(Constants.GAME_SCORE_KEY, score);
            b.putLong(Constants.GAME_TIME_KEY, timeMs);
            startActivity(gameOverIntent, b);
            finish();
        }
